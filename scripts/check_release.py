...
def check_imports():
    ...
    try:
        ...
        # 检查核心模块导入
        from fivc.core.implements.utils import load_component_site  # noqa: F401

        print("✅ load_component_site 导入成功")

        from fivc.core.interfaces.utils import query_component  # noqa: F401

        print("✅ query_component 导入成功")

        # 检查接口导入
        from fivc.core.interfaces import caches, configs, loggers  # noqa: F401

        print("✅ 核心接口导入成功")

        # 检查实现导入
        from fivc.core.implements import ComponentSite  # noqa: F401
